...
public interface DBus extends DBusInterface {
     ...
     * the
     * <a href="http://dbus.freedesktop.org/doc/dbus-specification.html#introspection-format">Introspection
     * Format</a>.
     */
    ...
    public interface Properties extends DBusInterface {
         ...
         * @param interface_name The interface this property is associated with.
         * @param property_name The name of the property.
         * @param value The new value of the property (may be any valid DBus
         * type).
         */
         ...
         *
         * @param interface_name The interface the properties is associated
         * with.
