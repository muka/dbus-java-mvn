...
public class DirectConnection extends AbstractConnection {
     ...
     *
     * @param address The address to connect to. This is a standard D-Bus
     * address, except that the additional parameter 'listen=true' should be
    ...
    DBusInterface dynamicProxy(String path) throws DBusException {
        try {
            ...
            throw new DBusException(MessageFormat.format(t("Failed to create proxy object for {0}; reason: {1}."), new Object[]{path, e.getMessage()}));
        }
    }
