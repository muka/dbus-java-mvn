...
public class Marshalling {
     ...
     * @throws DBusException If the given type cannot be converted to a DBus
     * type.
     */
     ...
     *
     * @param c The Java type.
     * @param basic If true enforces this to be a non-compound type. (compound
     ...
     * @throws DBusException Thrown if there is an error in converting the
     * objects.
     */
    @SuppressWarnings("unchecked")
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            if (parameters[i] instanceof DBusSerializable) {
                ...
                i--;
                    ...
                    && !(parameters[i] instanceof Variant)) // its an unwrapped variant, wrap it
            {
